...
public static class RangeSpikeShotCatalog
{
    ...
    {
        new("gen_lw",  "60° Wedge",    "LW",     new Color("f0c040"),  82.0f, 28.0f, 0f, 9200.0f, 0f),
        new("gen_sw",  "Sand Wedge",   "SW",     new Color("f0c040"),  90.0f, 26.0f, 0f, 9000.0f, 0f),
        new("gen_gw",  "Gap Wedge",    "GW",     new Color("f0c040"),  98.0f, 24.0f, 0f, 8800.0f, 0f),
        new("gen_pw",  "Pitching Wedge","PW",    new Color("f0c040"), 104.0f, 22.0f, 0f, 8500.0f, 0f),
        new("gen_9i",  "9 Iron",       "9I",     new Color("7dcfff"), 109.0f, 20.5f, 0f, 8000.0f, 0f),
        new("gen_8i",  "8 Iron",       "8I",     new Color("7dcfff"), 112.0f, 19.5f, 0f, 7500.0f, 0f),
        new("gen_7i",  "7 Iron",       "7I",     new Color("7dcfff"), 116.0f, 18.5f, 0f, 7000.0f, 0f),
        new("gen_6i",  "6 Iron",       "6I",     new Color("7dcfff"), 120.0f, 17.5f, 0f, 6200.0f, 0f),
        new("gen_5i",  "5 Iron",       "5I",     new Color("7dcfff"), 124.0f, 16.5f, 0f, 5500.0f, 0f),
        new("gen_4i",  "4 Iron",       "4I",     new Color("7dcfff"), 128.0f, 16.0f, 0f, 5000.0f, 0f),
        new("gen_3i",  "3 Iron",       "3I",     new Color("7dcfff"), 132.0f, 15.5f, 0f, 4800.0f, 0f),
        new("gen_4h",  "4 Hybrid",     "4H",     new Color("a8e6a8"), 138.0f, 15.0f, 0f, 4500.0f, 0f),
        new("gen_5w",  "5 Wood",       "5W",     new Color("a8e6a8"), 145.0f, 14.0f, 0f, 4100.0f, 0f),
        new("gen_3w",  "3 Wood",       "3W",     new Color("a8e6a8"), 152.0f, 13.0f, 0f, 3500.0f, 0f),
        new("gen_dr",  "Driver",       "DRIVER", new Color("ff9966"), 160.0f, 12.0f, 0f, 2700.0f, 0f),
    };
